  ...
  return (
    <AptitudeGuruStyle>  
      <div className="container1">
       <h1 className="container1-header">Aptitude Guru Hem</h1>
       <h1>At AGH, we shape futures and build skills that matter.</h1>
       <emp>strive for your excellence.</emp>
...
<button className="button-1">Start your learning</button>
