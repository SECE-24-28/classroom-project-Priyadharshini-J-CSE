  ...
  <button className="b2">Know More</button>
    ...
    <div className="container10">
      ...
      <div className="bigbox">
       ...
       <div className="bigbox">
        <div className="smallbox"><h1><i class="fa-solid fa-diamond-turn-right"></i>hTop Code Quality</h1><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Volupt
          ate expedita beatae eaque fuga doloremque nam dolore dolores a, suscipit, nemo illum assumenda dolor debitis animi officiis inventore voluptatum, iste libero!Lorem</p></div>
