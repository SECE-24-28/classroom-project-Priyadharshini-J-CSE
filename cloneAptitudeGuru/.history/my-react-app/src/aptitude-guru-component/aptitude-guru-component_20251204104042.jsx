  ...
  <button className="b2">Know More</button>
    ...
    <div className="container9">
      ...
      <div className="full-box">
        ...
        <div className="semi-box">
           <div className="box" style={{backgroundColor:"rgb(255, 223, 228)"}}><div><h2>Study Materials</h2> <h1>1000+</h1></div><img src="/image7.png" alt="img5" /></div>
          <div className="box" style={{backgroundColor:"rgb(255, 223, 228)"}}><div><h2>Professional Trainer</h2> <h1>100+</h1></div><img src="/image8.png" alt="img5" /></div>
        </div>
      </div>
