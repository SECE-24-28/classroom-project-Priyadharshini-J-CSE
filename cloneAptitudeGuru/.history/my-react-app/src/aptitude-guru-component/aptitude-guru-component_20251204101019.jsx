    ...
    <div className="container9">
      ...
      <div className="full-box">
        ...
        <div className="semi-box">
          <div className="box"><div><h2>Colleges</h2> <h1>100+</h1></div><div className="img-div"><img src="/image5.png" alt="img5" /></div></div>
         <div className="box"><h2>Colleges</h2> <h1>100+</h1></div>
        </div>
