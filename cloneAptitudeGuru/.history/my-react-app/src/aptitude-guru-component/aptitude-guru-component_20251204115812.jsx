...
<div className="box-button">
  ...
  <button className="b2">Know More</button>
    ...
    <div className="container10">
      <h1 className="head">Our Promise</h1>
      <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Necessitatibus molestias eligendi atque modi, cum dolore veritatis cumque minima, officiis debitis labo
