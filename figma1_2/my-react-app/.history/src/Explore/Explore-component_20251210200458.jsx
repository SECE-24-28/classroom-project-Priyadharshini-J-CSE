...
const ExploreComponent=()=>{
    return(
        ...
        <div>
            ...
            <div className="below">
                <div className="box">
                <div className="img1"><img src="/explore1.png" alt="img1" /></div>
                <div className="des"><h1>Dining Sets</h1> <div className="circle"><h1>→</h1></div></div></div>

                <div className="box">
                <div className="img1"><img src="/explore2.png" alt="img2" /></div>
                <div className="des"><h1>Dining Sets</h1> <div className="circle"><h1>→</h1></div></div></div>

                <div className="box">
                <div className="img1"><img src="/explore3.png" alt="img3" /></div>
                <div className="des"><h1>Dining Sets</h1> <div className="circle"><h1>→</h1></div></div></div>
